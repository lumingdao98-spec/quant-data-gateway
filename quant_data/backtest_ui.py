    ...
    <div class="work">
      ...
      <div class="panel">
        ...
        <div class="panel-b">
          ...
          <div class="quick-trades" style="margin-top:8px"><div class="quick-head"><b>买卖明细</b><button class="link-btn" onclick="scrollTradeTable()">完整表格</button></div><div id="tradeQuickList" class="quick-list"><div class="muted">运行后显示最近交易。</div></div></div>
        </div>
      </div>
    </div>
