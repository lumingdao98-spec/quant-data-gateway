...
- `/api/market/global-sentiment` 汇总恒生科技、日经、韩国综合、纳斯达克、纳指期货、费城半导体和标普期货等真实可追溯数据，并明确区分“现金盘交易中、期货交易中、盘前/盘后、前收盘、过期或缺失”；
- 同属美国科技股或同一地区的高相关指数不会被简单累加，按资产家族去重并设置权重上限，避免纳指、纳指期货和费城半导体重复放大同一风险；
- 全球科技环境最多占大盘环境分的 15%，且必须有国内市场证据。数据过期、来源不足或只有单一相关家族时保持中性，不触发自动买入；
